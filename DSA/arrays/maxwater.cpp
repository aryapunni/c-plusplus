//Container with most Water - You are given an integer array 
//height of length n. 
...
//across containers). 
//Return the area(that the 2 lines and the X axis make) of container 
//which can store the max amount of water. 
